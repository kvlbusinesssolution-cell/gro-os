...
const PURPOSE_LABEL: Record<DraftPurpose, string> = {
  ...
  // Phase 20 (Autonomous AI Job Application Agent) — real recruiter/hiring-
  // manager emails for this purpose are generated by career/cover-letter.ts
  // (grounded strictly in the candidate's own verified data), never by this
  // generic sales-outreach personalization generator. Present only so this
  // exhaustive Record stays exhaustive.
  JOB_APPLICATION: "a job application email to a recruiter or hiring manager",
};
